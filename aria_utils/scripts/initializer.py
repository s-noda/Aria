...
#        currentor.set_torques(currentor.torques)
        currentor.set_interpolate(self.id_map['neck1'], 'interpolateTLinear', 5.0)
        currentor.torques[self.id_map['neck1']] = currentor.set_torque(self.id_map['neck1'], 0.0)
        time.sleep(0.1)
        currentor.set_interpolate(self.id_map['neck2'], 'interpolateTLinear', 5.0)
        currentor.torques[self.id_map['neck2']] = currentor.set_torque(self.id_map['neck2'], 0.0)
        time.sleep(0.1)
        currentor.set_interpolate(self.id_map['neck3'], 'interpolateTLinear', 5.0)
        currentor.torques[self.id_map['neck3']] = currentor.set_torque(self.id_map['neck3'], 0.0)
        time.sleep(0.1)
        currentor.set_interpolate(self.id_map['arm_r_joint1'], 'interpolateTLinear', 5.0)
        currentor.torques[self.id_map['arm_r_joint1']] = currentor.set_torque(self.id_map['arm_r_joint1'], 0.0)
        time.sleep(0.1)
        currentor.set_interpolate(self.id_map['arm_r_joint2'], 'interpolateTLinear', 5.0)
        currentor.torques[self.id_map['arm_r_joint2']] = currentor.set_torque(self.id_map['arm_r_joint2'], 0.0)
        time.sleep(0.1)
        currentor.set_interpolate(self.id_map['arm_r_joint3'], 'interpolateTLinear', 5.0)
        currentor.torques[self.id_map['arm_r_joint3']] = currentor.set_torque(self.id_map['arm_r_joint3'], 0.0)
        time.sleep(0.1)
        currentor.set_interpolate(self.id_map['arm_r_joint4'], 'interpolateTLinear', 5.0)
        currentor.torques[self.id_map['arm_r_joint4']] = currentor.set_torque(self.id_map['arm_r_joint4'], 0.0)
        time.sleep(0.1)
        currentor.set_interpolate(self.id_map['arm_r_joint5'], 'interpolateTLinear', 5.0)
        currentor.torques[self.id_map['arm_r_joint5']] = currentor.set_torque(self.id_map['arm_r_joint5'], 0.0)
        time.sleep(0.1)
        currentor.set_interpolate(self.id_map['arm_r_joint6'], 'interpolateTLinear', 5.0)
        currentor.torques[self.id_map['arm_r_joint6']] = currentor.set_torque(self.id_map['arm_r_joint6'], 0.0)
        time.sleep(0.1)
        currentor.set_interpolate(self.id_map['arm_r_joint7'], 'interpolateTLinear', 5.0)
        currentor.torques[self.id_map['arm_r_joint7']] = currentor.set_torque(self.id_map['arm_r_joint7'], 0.0)
        time.sleep(0.1)
        currentor.set_interpolate(self.id_map['arm_l_joint1'], 'interpolateTLinear', 5.0)
        currentor.torques[self.id_map['arm_l_joint1']] = currentor.set_torque(self.id_map['arm_l_joint1'], 0.0)
        time.sleep(0.1)
        currentor.set_interpolate(self.id_map['arm_l_joint2'], 'interpolateTLinear', 5.0)
        currentor.torques[self.id_map['arm_l_joint2']] = currentor.set_torque(self.id_map['arm_l_joint2'], 0.0)
        time.sleep(0.1)
        currentor.set_interpolate(self.id_map['arm_l_joint3'], 'interpolateTLinear', 5.0)
        currentor.torques[self.id_map['arm_l_joint3']] = currentor.set_torque(self.id_map['arm_l_joint3'], 0.0)
        time.sleep(0.1)
        currentor.set_interpolate(self.id_map['arm_l_joint4'], 'interpolateTLinear', 5.0)
        currentor.torques[self.id_map['arm_l_joint4']] = currentor.set_torque(self.id_map['arm_l_joint4'], 0.0)
        time.sleep(0.1)
        currentor.set_interpolate(self.id_map['arm_l_joint5'], 'interpolateTLinear', 5.0)
        currentor.torques[self.id_map['arm_l_joint5']] = currentor.set_torque(self.id_map['arm_l_joint5'], 0.0)
        time.sleep(0.1)
        currentor.set_interpolate(self.id_map['arm_l_joint6'], 'interpolateTLinear', 5.0)
        currentor.torques[self.id_map['arm_l_joint6']] = currentor.set_torque(self.id_map['arm_l_joint6'], 0.0)
        time.sleep(0.1)
        currentor.set_interpolate(self.id_map['arm_l_joint7'], 'interpolateTLinear', 5.0)
        currentor.torques[self.id_map['arm_l_joint7']] = currentor.set_torque(self.id_map['arm_l_joint7'], 0.0)
        time.sleep(10)
        currentor.set_interpolate(self.id_map['body'], 'interpolateTLinear', 5.0)
        currentor.torques[self.id_map['body']] = currentor.set_torque(self.id_map['body'], 0.0)
        time.sleep(5)
        currentor.set_interpolate(self.id_map['hip2'], 'interpolateTLinear', 5.0)
        currentor.torques[self.id_map['hip2']] = currentor.set_torque(self.id_map['hip2'], 0.0)
        time.sleep(5)
        currentor.set_interpolate(self.id_map['hip3'], 'interpolateTLinear', 5.0)
        currentor.torques[self.id_map['hip3']] = currentor.set_torque(self.id_map['hip3'], 0.0)
        time.sleep(0.1)
