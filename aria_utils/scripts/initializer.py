...
class Settings:
    ...
    def send_zero(self):
        ...
        currentor.set_interpolates('interpolateTLinear', 10.0)
    ...
    def initiate(self):
        ...
        time.sleep(0.1)
        currentor.set_interpolate(self.id_map['neck1'], 'interpolatePLinear', 5.0)
        currentor.set_control_mode(self.id_map['neck1'], currentor.mode_pos)
        time.sleep(0.1)
        currentor.set_interpolate(self.id_map['neck2'], 'interpolatePLinear', 5.0)
        currentor.set_control_mode(self.id_map['neck2'], currentor.mode_pos)
        time.sleep(0.1)
        currentor.set_interpolate(self.id_map['neck3'], 'interpolatePLinear', 5.0)
        ...
        time.sleep(1)
        currentor.set_interpolate(self.id_map['hip2'], 'interpolatePLinear', 5.0)
        currentor.set_control_mode(self.id_map['hip2'], currentor.mode_pos)
        time.sleep(0.1)
        currentor.set_interpolate(self.id_map['hip3'], 'interpolatePLinear', 5.0)
        ...
        currentor.set_positions(currentor.positions)
        time.sleep(1)
        currentor.set_interpolate(self.id_map['arm_r_joint1'], 'interpolatePLinear', 5.0)
        ...
        time.sleep(0.1)
        currentor.set_interpolate(self.id_map['arm_r_joint2'], 'interpolatePLinear', 5.0)
        ...
        time.sleep(0.1)
        currentor.set_interpolate(self.id_map['arm_r_joint3'], 'interpolatePLinear', 5.0)
        ...
        time.sleep(0.1)
        currentor.set_interpolate(self.id_map['arm_r_joint4'], 'interpolatePLinear', 5.0)
        ...
        time.sleep(0.1)
        currentor.set_interpolate(self.id_map['arm_r_joint5'], 'interpolatePLinear', 5.0)
        ...
        time.sleep(0.1)
        currentor.set_interpolate(self.id_map['arm_r_joint6'], 'interpolatePLinear', 5.0)
        ...
        time.sleep(0.1)
        currentor.set_interpolate(self.id_map['arm_r_joint7'], 'interpolatePLinear', 5.0)
        ...
        time.sleep(0.1)
        currentor.set_interpolate(self.id_map['arm_l_joint1'], 'interpolatePLinear', 5.0)
        ...
        time.sleep(0.1)
        currentor.set_interpolate(self.id_map['arm_l_joint2'], 'interpolatePLinear', 5.0)
        ...
        time.sleep(0.1)
        currentor.set_interpolate(self.id_map['arm_l_joint3'], 'interpolatePLinear', 5.0)
        ...
        time.sleep(0.1)
        currentor.set_interpolate(self.id_map['arm_l_joint4'], 'interpolatePLinear', 5.0)
        ...
        time.sleep(0.1)
        currentor.set_interpolate(self.id_map['arm_l_joint5'], 'interpolatePLinear', 5.0)
        ...
        time.sleep(0.1)
        currentor.set_interpolate(self.id_map['arm_l_joint6'], 'interpolatePLinear', 5.0)
        ...
        time.sleep(0.1)
        currentor.set_interpolate(self.id_map['arm_l_joint7'], 'interpolatePLinear', 5.0)
        ...
        time.sleep(0.1)
        currentor.set_interpolate(self.id_map['body'], 'interpolatePLinear', 5.0)
...
if __name__ == '__main__':
    ...
    # call each publisher once to get node starting
    currentor.set_interpolates('dummy', 0.0)
    currentor.set_control_modes(currentor.modes)
    currentor.set_torques(currentor.torques)
    currentor.set_positions(currentor.positions)
    # apply initial gain
